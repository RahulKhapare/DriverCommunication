...
public class ModelPacket05A8 {
    ...
    public String parsePacket(String responseData) {
        ...
        AppLogs.generate(packet.PKT_05A8 + " Response :  " + value);
        ...
        if (packetId.equalsIgnoreCase(packet.PKT_05A8)) {
            ...
            returnValue = "Packet Matched 05A8";

        } else {
            returnValue = "Packet Id Not Matched 05A8";
        }
