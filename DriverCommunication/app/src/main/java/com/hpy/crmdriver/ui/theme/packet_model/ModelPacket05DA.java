...
public class ModelPacket05DA {
    ...
    public String generatePacket() {
        return packetId + length + input1 + input2;
    }
    ...
    public String parsePacket(String responseData) {
        ...
        AppLogs.generate(packet.PKT_05DA + " Response :  " + value);
        ...
        if (packetId.equalsIgnoreCase(packet.PKT_05DA)) {
            ...
            returnValue = "Packet Matched 05DA";

        } else {
            returnValue = "Packet Id Not Matched 05DA";
        }
