...
public class ModelPacket058B {
    ...
    public String parsePacket(String responseData) {
        ...
        AppLogs.generate(packet.PKT_058B + " Response :  " + value);
        ...
        if (packetId.equalsIgnoreCase(packet.PKT_058B)) {
            ...
            int length16 = stringHelper.getMultiplyValue(size.SIZE_6);
            String reserved = stringHelper.getSubstringData(value, startPos16, startPos16 + length16);
            ...
            returnValue = "Packet Matched 058B";

        } else {
            returnValue = "Packet Id Not Matched 058B";
        }
