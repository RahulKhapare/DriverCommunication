...
public class ModelPacket05A9 {
    ...
    public String parsePacket(String responseData) {
        ...
        AppLogs.generate(packet.PKT_05A9 + " Response :  " + value);
        ...
        if (packetId.equalsIgnoreCase(packet.PKT_05A9)) {
            ...
            returnValue = "Packet Matched 05A9";

        } else {
            returnValue = "Packet Id Not Matched 05A9";
        }
