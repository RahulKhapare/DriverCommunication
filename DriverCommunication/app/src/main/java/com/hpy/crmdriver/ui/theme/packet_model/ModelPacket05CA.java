...
public class ModelPacket05CA {
    ...
    public String parsePacket(String responseData) {
        ...
        AppLogs.generate(packet.PKT_05CA + " Response :  " + value);
        ...
        if (packetId.equalsIgnoreCase(packet.PKT_05CA)) {
            ...
            returnValue = "Packet Matched 05CA";

        } else {
            returnValue = "Packet Id Not Matched 05CA";
        }
