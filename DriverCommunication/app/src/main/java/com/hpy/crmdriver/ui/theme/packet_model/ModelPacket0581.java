...
public class ModelPacket0581 {
    ...
    public String generatePacket() {
        return packetId + length + statusInfo;
    }
    ...
    public String parsePacket(String responseData) {
        ...
        AppLogs.generate(packet.PKT_0581 + " Response :  " + value);
        ...
        if (packetId.equalsIgnoreCase(packet.PKT_0581)) {

            int startPos3 = startPos2 + length2;
            int length3 = stringHelper.getMultiplyValue(size.SIZE_24);
            String statusInformation = stringHelper.getSubstringData(value, startPos3, startPos3 + length3);

            setPacketId(packetId);
            setLength(length);
            setStatusInfo(statusInformation);

            returnValue = "Packet Matched 0581";

        } else {
            returnValue = "Packet Id Not Matched 0581";
        }
