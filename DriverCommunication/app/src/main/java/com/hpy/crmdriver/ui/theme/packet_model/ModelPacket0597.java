...
public class ModelPacket0597 {
    ...
    public String parsePacket(String responseData) {
        ...
        AppLogs.generate(packet.PKT_0597 + " Response :  " + value);
        ...
        if (packetId.equalsIgnoreCase(packet.PKT_0597)) {
            ...
            returnValue = "Packet Matched 0597";
        } else {
            returnValue = "Packet Id Not Matched 0597";
        }
