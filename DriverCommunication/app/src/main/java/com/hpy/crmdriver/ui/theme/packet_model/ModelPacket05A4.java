...
public class ModelPacket05A4 {
    ...
    public String parsePacket(String responseData) {
        ...
        AppLogs.generate(packet.PKT_05A4 + " Response :  " + value);
        ...
        if (packetId.equalsIgnoreCase(packet.PKT_05A4)) {
            ...
            returnValue = "Packet Matched 05A4";
        } else {
            returnValue = "Packet Id Not Matched 05A4";
        }
