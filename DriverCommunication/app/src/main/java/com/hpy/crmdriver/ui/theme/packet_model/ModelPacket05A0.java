...
public class ModelPacket05A0 {
    ...
    public String parsePacket(String responseData) {
        ...
        AppLogs.generate(packet.PKT_05A0 + " Response :  " + value);
        ...
        if (packetId.equalsIgnoreCase(packet.PKT_05A0)) {
            ...
            returnValue = "Packet Matched 05A0";

        } else {
            returnValue = "Packet Id Not Matched 05A0";
        }
