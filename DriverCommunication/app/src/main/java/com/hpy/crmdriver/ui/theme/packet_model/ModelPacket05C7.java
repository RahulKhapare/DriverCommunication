...
public class ModelPacket05C7 {
    ...
    public String parsePacket(String responseData) {
        ...
        AppLogs.generate(packet.PKT_05C7 + " Response :  " + value);
        ...
        if (packetId.equalsIgnoreCase(packet.PKT_05C7)) {
            ...
            returnValue = "Packet Matched 05C7";

        } else {
            returnValue = "Packet Id Not Matched 05C7";
        }
