...
public class ModelPacket05A1 {
    ...
    public String parsePacket(String responseData) {
        ...
        AppLogs.generate(packet.PKT_05A1 + " Response :  " + value);
        ...
        if (packetId.equalsIgnoreCase(packet.PKT_05A1)) {
            ...
            returnValue = "Packet Matched 05A1";
        } else {
            returnValue = "Packet Id Not Matched 05A1";
        }
