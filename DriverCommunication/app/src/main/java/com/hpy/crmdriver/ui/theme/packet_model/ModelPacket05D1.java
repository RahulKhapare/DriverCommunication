...
public class ModelPacket05D1 {
    ...
    public String parsePacket(String responseData) {
        ...
        AppLogs.generate(packet.PKT_05D1 + " Response :  " + value);
        ...
        if (packetId.equalsIgnoreCase(packet.PKT_05D1)) {
            ...
            returnValue = "Packet Matched 05D1";

        } else {
            returnValue = "Packet Id Not Matched 05D1";
        }
