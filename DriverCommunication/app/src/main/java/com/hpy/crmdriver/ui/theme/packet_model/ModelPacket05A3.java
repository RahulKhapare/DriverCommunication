...
public class ModelPacket05A3 {
    ...
    public String parsePacket(String responseData) {
        ...
        AppLogs.generate(packet.PKT_05A3 + " Response :  " + value);
        ...
        if (packetId.equalsIgnoreCase(packet.PKT_05A3)) {
            ...
            returnValue = "Packet Matched PKT_05A3";

        } else {
            returnValue = "Packet Id Not Matched PKT_05A3";
        }
