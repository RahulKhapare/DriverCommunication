...
public class ModelPacket0591 {
    ...
    public String parsePacket(String responseData) {
        ...
        AppLogs.generate(packet.PKT_0591 + " Response :  " + value);
        ...
        if (packetId.equalsIgnoreCase(packet.PKT_0591)) {
            ...
            returnValue = "Packet Matched 0591";
        } else {
            returnValue = "Packet Id Not Matched 0591";
        }
