...
public class ModelPacket0592 {
    ...
    public String parsePacket(String responseData) {
        ...
        AppLogs.generate(packet.PKT_0592 + " Response :  " + value);
        ...
        if (packetId.equalsIgnoreCase(packet.PKT_0592)) {
            ...
            returnValue = "Packet Matched 0592";

        } else {
            returnValue = "Packet Id Not Matched 0592";
        }
