...
public class ModelPacket05D2 {
    ...
    public String parsePacket(String responseData) {
        ...
        AppLogs.generate(packet.PKT_05D2 + " Response :  " + value);
        ...
        if (packetId.equalsIgnoreCase(packet.PKT_05D2)) {
            ...
            returnValue = "Packet Matched 05D2";

        } else {
            returnValue = "Packet Id Not Matched 05D2";
        }
