...
public class ModelPacket05CB {
    ...
    public String parsePacket(String responseData) {
        ...
        AppLogs.generate(packet.PKT_05CB + " Response :  " + value);
        ...
        if (packetId.equalsIgnoreCase(packet.PKT_05CB)) {
            ...
            returnValue = "Packet Matched 05CB";

        } else {
            returnValue = "Packet Id Not Matched 05CB";
        }
