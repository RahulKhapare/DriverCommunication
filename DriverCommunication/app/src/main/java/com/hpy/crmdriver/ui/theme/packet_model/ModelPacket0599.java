...
public class ModelPacket0599 {
    ...
    public String parsePacket(String responseData) {
        ...
        AppLogs.generate(packet.PKT_0599 + " Response :  " + value);
        ...
        if (packetId.equalsIgnoreCase(packet.PKT_0599)) {
            ...
            returnValue = "Packet Matched 0599";
        } else {
            returnValue = "Packet Id Not Matched 0599";
        }
