...
public class ModelPacket0594 {
    ...
    public String parsePacket(String responseData) {
        ...
        AppLogs.generate(packet.PKT_0594 + " Response :  " + value);
        ...
        if (packetId.equalsIgnoreCase(packet.PKT_0594)) {
            ...
            returnValue = "Packet Matched 0594";
        } else {
            returnValue = "Packet Id Not Matched 0594";
        }
