...
public class ModelPacket05A6 {
    ...
    public String parsePacket(String responseData) {
        ...
        AppLogs.generate(packet.PKT_05A6 + " Response :  " + value);
        ...
        if (packetId.equalsIgnoreCase(packet.PKT_05A6)) {
            ...
            returnValue = "Packet Matched 05A6";

        } else {
            returnValue = "Packet Id Not Matched 05A6";
        }
