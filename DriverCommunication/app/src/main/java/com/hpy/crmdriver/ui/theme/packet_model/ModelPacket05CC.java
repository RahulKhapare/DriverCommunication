...
public class ModelPacket05CC {
    ...
    public String parsePacket(String responseData) {
        ...
        AppLogs.generate(packet.PKT_05CC + " Response :  " + value);
        ...
        if (packetId.equalsIgnoreCase(packet.PKT_05CC)) {
            ...
            returnValue = "Packet Matched 05CC";

        } else {
            returnValue = "Packet Id Not Matched 05CC";
        }
