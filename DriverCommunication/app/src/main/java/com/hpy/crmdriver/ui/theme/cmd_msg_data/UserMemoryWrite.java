...
import com.hpy.crmdriver.ui.theme.packet_model.ModelPacket0574;
import com.hpy.crmdriver.ui.theme.packet_model.ModelPacket0575;
import com.hpy.crmdriver.ui.theme.packet_model.ModelPacket0581;
import com.hpy.crmdriver.ui.theme.packet_model.ModelPacket0669;
...
public class UserMemoryWrite {
    ...
    public ModelPacket0574 modelPacket0574 = new ModelPacket0574();
    public ModelPacket0575 modelPacket0575 = new ModelPacket0575();
    public ModelPacket0669 modelPacket0669 = new ModelPacket0669();
    public ModelPacket066A modelPacket066A = new ModelPacket066A();
...
//
//        modelPacket0574.setPacketId(packet.PKT_0574);
//        modelPacket0574.setLength(length.LENGTH_000E);
//        modelPacket0574.setRoomNo("");
//        modelPacket0574.setRoomOperation("");
//        modelPacket0574.setBanknoteInfo("");
//
//        modelPacket0575.setPacketId(packet.PKT_0575);
//        modelPacket0575.setLength(length.LENGTH_0014);
//        modelPacket0575.setHardwareType("");
//        modelPacket0575.setReserved("");
//        modelPacket0575.setSerialNo("");
//
//        modelPacket0669.setPacketId(packet.PKT_0669);
//        modelPacket0669.setLength("");//not defined in doc
//        modelPacket0669.parsePacket("");
//
//        modelPacket066A.setPacketId(packet.PKT_066A);
//        modelPacket066A.setLength("");//not defined in doc
//        modelPacket066A.parsePacket("");

//        returnValue = modelPacket0001.generatePacket() + modelPacket0002.generatePacket() + modelPacket0573.generatePacket() +
//                modelPacket0574.generatePacket() + modelPacket0575.generatePacket() + modelPacket0669.generatePacket() +
//                modelPacket066A.generatePacket();
