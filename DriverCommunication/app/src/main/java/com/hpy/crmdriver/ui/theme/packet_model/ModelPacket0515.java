...
public class ModelPacket0515 {
    ...
    public String generatePacket() {
        return packetId + length + status + input1 + input2 + input3 + input4 + reserved;
    }
    ...
    public String parsePacket(String responseData) {
        ...
        if (packetId.equalsIgnoreCase(packet.PKT_0515)) {
            ...
            int length8 = stringHelper.getMultiplyValue(size.SIZE_160);
            String reserved = stringHelper.getSubstringData(value, startPos8, startPos8 + length8);
