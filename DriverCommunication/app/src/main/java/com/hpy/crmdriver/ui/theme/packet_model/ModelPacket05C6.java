...
public class ModelPacket05C6 {
    ...
    public String parsePacket(String responseData) {
        ...
        AppLogs.generate(packet.PKT_05C6 + " Response :  " + value);
        ...
        if (packetId.equalsIgnoreCase(packet.PKT_05C6)) {
            ...
            returnValue = "Packet Matched 05C6";
        } else {
            returnValue = "Packet Id Not Matched 05C6";
        }
