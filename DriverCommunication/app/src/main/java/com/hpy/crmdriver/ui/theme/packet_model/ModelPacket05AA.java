...
public class ModelPacket05AA {
    ...
    public String parsePacket(String responseData) {
        ...
        AppLogs.generate(packet.PKT_05AA + " Response :  " + value);
        ...
        if (packetId.equalsIgnoreCase(packet.PKT_05AA)) {
            ...
            returnValue = "Packet Matched 05AA";

        } else {
            returnValue = "Packet Id Not Matched 05AA";
        }
