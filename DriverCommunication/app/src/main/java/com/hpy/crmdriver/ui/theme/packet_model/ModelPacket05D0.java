...
public class ModelPacket05D0 {
    ...
    public String parsePacket(String responseData) {
        ...
        AppLogs.generate(packet.PKT_05D0 + " Response :  " + value);
        ...
        if (packetId.equalsIgnoreCase(packet.PKT_05D0)) {
            ...
            returnValue = "Packet Matched 05D0";
        } else {
            returnValue = "Packet Id Not Matched 05D0";
        }
