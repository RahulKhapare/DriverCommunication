...
import com.hpy.crmdriver.ui.theme.packet_model.ModelPacket05BC;
...
public class ReadStatus {
    ...
    public String generateCommand() {
        ...
        modelPacket0001.setCommand("0C00");
    ...
    public ModelPacket05BC modelPacket05BC = new ModelPacket05BC();
    ...
    public void parseCommandResponse(Context context, String responseData) {
        ...
        if (!TextUtils.isEmpty(value)) {
            ...
            int length5 = stringHelper.getMultiplyValue(size.SIZE_124);
            String warningInformation = stringHelper.getSubstringData(value, startPos5, startPos5 + length5);
            modelPacket05BC.parsePacket(warningInformation);
            sessionModel.saveModelToSession(context, packet.PKT_05BC, modelPacket05BC);
        }
    }
