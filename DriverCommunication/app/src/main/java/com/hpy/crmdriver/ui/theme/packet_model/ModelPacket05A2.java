...
public class ModelPacket05A2 {
    ...
    public String parsePacket(String responseData) {
        ...
        AppLogs.generate(packet.PKT_05A2 + " Response :  " + value);
        ...
        if (packetId.equalsIgnoreCase(packet.PKT_05A2)) {
            ...
            returnValue = "Packet Matched 05A2";

        } else {
            returnValue = "Packet Id Not Matched 05A2";
        }
