...
public class ModelPacket05A7 {
    ...
    public String parsePacket(String responseData) {
        ...
        AppLogs.generate(packet.PKT_05A7 + " Response :  " + value);
        ...
        if (packetId.equalsIgnoreCase(packet.PKT_05A7)) {
            ...
            returnValue = "Packet Matched 05A7";

        } else {
            returnValue = "Packet Id Not Matched 05A7";
        }
