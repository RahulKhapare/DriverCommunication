...
public class ModelPacket058A {
    ...
    public String parsePacket(String responseData) {
        ...
        AppLogs.generate(packet.PKT_058A + " Response :  " + value);
        ...
        if (packetId.equalsIgnoreCase(packet.PKT_058A)) {

            int startPos3 = startPos2 + length2;
            int length3 = stringHelper.getMultiplyValue(size.SIZE_2);
            String cs = stringHelper.getSubstringData(value, startPos3, startPos3 + length3);

            int startPos4 = startPos3 + length3;
            int length4 = stringHelper.getMultiplyValue(size.SIZE_2);
            String esc = stringHelper.getSubstringData(value, startPos4, startPos4 + length4);

            int startPos5 = startPos4 + length4;
            int length5 = stringHelper.getMultiplyValue(size.SIZE_2);
            String ts = stringHelper.getSubstringData(value, startPos5, startPos5 + length5);

            int startPos6 = startPos5 + length5;
            int length6 = stringHelper.getMultiplyValue(size.SIZE_2);
            String input_1 = stringHelper.getSubstringData(value, startPos6, startPos6 + length6);

            int startPos7 = startPos6 + length6;
            int length7 = stringHelper.getMultiplyValue(size.SIZE_2);
            String input_2 = stringHelper.getSubstringData(value, startPos7, startPos7 + length7);

            int startPos8 = startPos7 + length7;
            int length8 = stringHelper.getMultiplyValue(size.SIZE_2);
            String input_3 = stringHelper.getSubstringData(value, startPos8, startPos8 + length8);

            int startPos9 = startPos8 + length8;
            int length9 = stringHelper.getMultiplyValue(size.SIZE_2);
            String input_4 = stringHelper.getSubstringData(value, startPos9, startPos9 + length9);

            int startPos10 = startPos9 + length9;
            int length10 = stringHelper.getMultiplyValue(size.SIZE_2);
            String input_5 = stringHelper.getSubstringData(value, startPos10, startPos10 + length10);

            int startPos11 = startPos10 + length10;
            int length11 = stringHelper.getMultiplyValue(size.SIZE_2);
            String input_6 = stringHelper.getSubstringData(value, startPos11, startPos11 + length11);

            int startPos12 = startPos11 + length11;
            int length12 = stringHelper.getMultiplyValue(size.SIZE_2);
            String input_7 = stringHelper.getSubstringData(value, startPos12, startPos12 + length12);

            int startPos13 = startPos12 + length12;
            int length13 = stringHelper.getMultiplyValue(size.SIZE_2);
            String input_8 = stringHelper.getSubstringData(value, startPos13, startPos13 + length13);

            int startPos14 = startPos13 + length13;
            int length14 = stringHelper.getMultiplyValue(size.SIZE_2);
            String input_9 = stringHelper.getSubstringData(value, startPos14, startPos14 + length14);

            int startPos15 = startPos14 + length14;
            int length15 = stringHelper.getMultiplyValue(size.SIZE_2);
            String input_10 = stringHelper.getSubstringData(value, startPos15, startPos15 + length15);

            int startPos16 = startPos15 + length15;
            int length16 = stringHelper.getMultiplyValue(size.SIZE_20);
            String reserved_1 = stringHelper.getSubstringData(value, startPos16, startPos16 + length16);

            int startPos17 = startPos16 + length16;
            int length17 = stringHelper.getMultiplyValue(size.SIZE_2);
            String urjb_1 = stringHelper.getSubstringData(value, startPos17, startPos17 + length17);

            int startPos18 = startPos17 + length17;
            int length18 = stringHelper.getMultiplyValue(size.SIZE_2);
            String urjb_2 = stringHelper.getSubstringData(value, startPos18, startPos18 + length18);

            int startPos19 = startPos18 + length18;
            int length19 = stringHelper.getMultiplyValue(size.SIZE_10);
            String reserved_2 = stringHelper.getSubstringData(value, startPos19, startPos19 + length19);
            ...
            returnValue = "Packet Matched 058A";

        } else {
            returnValue = "Packet Id Not Matched 058A";
        }
