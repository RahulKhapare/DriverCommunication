...
public class ModelPacket0598 {
    ...
    public String parsePacket(String responseData) {
        ...
        AppLogs.generate(packet.PKT_0598 + " Response :  " + value);
        ...
        if (packetId.equalsIgnoreCase(packet.PKT_0598)) {
            ...
            returnValue = "Packet Matched 0598";
        } else {
            returnValue = "Packet Id Not Matched 0598";
        }
