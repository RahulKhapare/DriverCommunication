...
public class ModelPacket05CD {
    ...
    public String parsePacket(String responseData) {
        ...
        AppLogs.generate(packet.PKT_05CD + " Response :  " + value);
        ...
        if (packetId.equalsIgnoreCase(packet.PKT_05CD)) {
            ...
            returnValue = "Packet Matched 05CD";

        } else {
            returnValue = "Packet Id Not Matched 05CD";
        }
