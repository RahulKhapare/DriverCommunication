...
public class ModelPacket05C8 {
    ...
    public String parsePacket(String responseData) {
        ...
        AppLogs.generate(packet.PKT_05C8 + " Response :  " + value);
        ...
        if (packetId.equalsIgnoreCase(packet.PKT_05C8)) {
            ...
            returnValue = "Packet Matched 05C8";
        } else {
            returnValue = "Packet Id Not Matched 05C8";
        }
