...
public class ModelPacket0593 {
    ...
    public String parsePacket(String responseData) {
        ...
        AppLogs.generate(packet.PKT_0593 + " Response :  " + value);
        ...
        if (packetId.equalsIgnoreCase(packet.PKT_0593)) {
            ...
            returnValue = "Packet Matched 0593";
        } else {
            returnValue = "Packet Id Not Matched 0593";
        }
