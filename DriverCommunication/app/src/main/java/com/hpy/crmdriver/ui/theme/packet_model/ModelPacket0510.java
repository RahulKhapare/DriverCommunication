...
public class ModelPacket0510 {
    ...
    public String parsePacket(String responseData) {
        ...
        AppLogs.generate(packet.PKT_0510 + " Response :  " + value);
        ...
        if (packetId.equalsIgnoreCase(packet.PKT_0510)) {
            ...
            returnValue = "Packet Matched 0510";

        } else {
            returnValue = "Packet Id Not Matched 0510";
        }
