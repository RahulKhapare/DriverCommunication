...
public class GetCassetteInfo {
    ...
    public void parseCommandResponse(Context context,String responseData) {
        ...
        if (!TextUtils.isEmpty(value)) {
            ...
            int length5 = stringHelper.getMultiplyValue(size.SIZE_254);
            String cassetteConfiguration = stringHelper.getSubstringData(value, startPos5, startPos5 + length5);
            modelPacket058E.parsePacket(cassetteConfiguration);
            sessionModel.saveModelToSession(context, packet.PKT_058E, modelPacket058E);
